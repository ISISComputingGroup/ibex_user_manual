...
:::{note}
This is disabled by default in IBEX. See [here](https://isiscomputinggroup.github.io/ibex_developers_manual/system_components/nicos/Running-Nicos-%28Script-Server%29.html) for information on how to enable it.
:::
