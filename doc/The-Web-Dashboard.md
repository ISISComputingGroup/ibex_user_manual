...
The view is read only and gives you a dashboard in a similar style to the desktop GUI as well as general instrument data and information on blocks. There is a toggle setting to show or hide hidden blocks.
...
The block names are links to a block history display plot. Access to the block history requires a username and password:
