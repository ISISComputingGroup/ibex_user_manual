...
- run `archive_water.exe` in `c:\Program Files (x86)\STFC ISIS Facility\ISIS Archive Watcher` interactively, optionally create a shortcut in the user logon startup menu 
