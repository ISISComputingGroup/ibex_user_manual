>[User Manual](wiki) > [Manage the DAE](https://github.com/ISISComputingGroup/ibex_user_manual/wiki/Manage-the-DAE) > [Add blocks to run title](Add-blocks-to-run-title)
