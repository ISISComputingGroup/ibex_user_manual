...
You should already be familiar with defining loops in Python but, as a reminder, the code above would translate into Python as::
...
As with loops, you should already be familiar with conditionals in Python. In ``OpenGENIE`` these look like::
